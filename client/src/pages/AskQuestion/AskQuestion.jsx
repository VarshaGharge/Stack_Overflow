                    ...
                    <form onSubmit={handleSubmit}> 
                        <div className='ask-form-container'>
                            <label htmlFor="ask-ques-title">
                                ...
                                <input type='text' onChange = {(e) => {setQuestionTitle(e.target.value)}} placeholder='e.g. Is there a R function for finding the index of an element in a vector?' id='ask-ques-title'/>
                            </label>
                            <label htmlFor="ask-ques-title">
                                <h4>Body</h4>
