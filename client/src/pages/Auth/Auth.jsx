    ...
    <section className='auth-section'>
        ...
        <div className='auth-container-2'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label htmlFor="email">
                    <h4>Email</h4>
                    <input type="email" name="email" id='eamil' onChange={(e) => {setEmail(e.target.value)}}/>
                </label>
                <label htmlFor="password">
                    <div style={{display:"flex", justifyContent:"space-between"}}>
                        ...
                        { isSignup && <p style={{ color: '#666767', fontSize:"13px" }}>Password must contain at least eight<br /> characters, including 1 letter and 1<br /> number.</p> }
                </label>
                {
                    isSignup && (
                        <label htmlFor='check'>
